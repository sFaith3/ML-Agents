...
public class PushAgent_2Blocks : Agent
{
    /// <summary>
    ...
    PushBlockSettings_2Blocks m_PushBlockSettings;
    ...
    /// </summary>
    [HideInInspector]
    public GoalDetect_2Blocks goalDetect;
    ...
    void Awake()
    {
        m_PushBlockSettings = FindObjectOfType<PushBlockSettings_2Blocks>();
    }
    ...
    public override void InitializeAgent()
    {
        ...
        {
            goalDetect = blocks[i].GetComponent<GoalDetect_2Blocks>();

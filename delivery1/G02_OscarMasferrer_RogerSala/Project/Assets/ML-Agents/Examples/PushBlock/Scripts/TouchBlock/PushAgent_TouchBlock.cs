...
public class PushAgent_TouchBlock : Agent
{
    /// <summary>
    ...
    PushBlockSettings_TouchBlock m_PushBlockSettings;
    ...
    void Awake()
    {
        m_PushBlockSettings = FindObjectOfType<PushBlockSettings_TouchBlock>();
    }
